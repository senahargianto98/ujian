    ...
    <div class="container" style="margin-top:100px;">
        <div class="row">
            ...
            <div class="col-sm-10">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="edit.php?id=<?php echo $d['id']; ?>">EDIT</a> | <a class="btn btn-danger" href="hapus.php?id=<?php echo $d['id']; ?>">HAPUS</a></td> 
                            </tr>
                        <?php
                        }
                        ?>
                ...
                <!-- Ini data Farmasi -->
                <h5>Farmasi</h5>
                <a href="tambahfarmasi.php" class="btn btn-primary">Tambah Farmasi</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">NO</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="edit1.php?id=<?php echo $d['id']; ?>">EDIT</a>| <a class="btn btn-danger" href="hapus1.php?id=<?php echo $d['id']; ?>">HAPUS</a></td>
                            </tr>
                        <?php
                        }
                        ?>
